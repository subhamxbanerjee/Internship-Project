...
import com.centuryply.portal.dto.StatusUpdateRequest;
import com.centuryply.portal.dto.CommentRequest;
import com.centuryply.portal.dto.AssignIncidentRequest;
...
public class IncidentController {
    ...
    public ResponseEntity<List<IncidentResponse>> listIncidents(Authentication auth) {
        List<IncidentResponse> incidents = incidentService.getAllIncidentsForUser(auth.getName())
                .stream()
    ...
    // ✅ Fixed Assign Endpoint
    @PutMapping("/{id}/assign")
    public ResponseEntity<IncidentResponse> assignEmployee(
            @Positive @PathVariable("id") Long id,
            @Valid @RequestBody AssignIncidentRequest request,
            Authentication auth) {

        Incident incident = incidentService.assignEmployee(
                id,
...
public ResponseEntity<IncidentResponse> updateStatus(
    ...
    public ResponseEntity<IncidentResponse> updatePriority(
        ...
        Incident incident = incidentService.updatePriority(
                id,
                request.getPriority(),
                auth.getName());
...
public ResponseEntity<IncidentResponse> addComment(
    ...
    Incident incident = incidentService.addComment(
            id,
            request.getComment(),
            auth.getName());
